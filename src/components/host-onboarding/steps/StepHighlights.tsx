...
export function StepHighlights({ data, onChange }: Props) {
  const toggle = (id: string) => {
    const updated = data.highlights.includes(id)
      ? data.highlights.filter((h) => h !== id)
